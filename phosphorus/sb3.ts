...
namespace P.sb3.compiler2 {
  ...
  export class Compiler {
    ...
    public statementLibrary: ObjectMap<StatementCompiler> = Object.create(null);
     ...
     */
    toType(input: CompiledInput, type: InputType): string {
      if (type === 'any') {
        return input.source;
      }
      if (input.type === type) {
     ...
     */
    getVariableScope(id: string): string {
